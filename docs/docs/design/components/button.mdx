...
<div className="hs-component-preview">
    <button className="hs-button is-error" role="button">
        <span className="hs-button__label">Button</span>
    </button>
    <button className="hs-button is-outlined is-error" role="button">
        <span className="hs-button__label">Button</span>
    </button>
  <button className="hs-button is-filled is-error" role="button">
    <span className="hs-button__label">Button</span>
  </button>
</div>
